/*========================================================
  ...
  MERGED EDITION — FULL CHAPTER + EXTRA GRAPH VISUALS + GRAPH-BASED EXAMPLES
========================================================*/
...
window.ChapterData = {
  ...
  sections: [
    ...
    {
      title: "0. Graphs — Complete Foundation",
      blocks: [
        {type:"paragraph", title:"From data to a picture", text:"Before drawing a graph, first understand what the numbers represent. Data may be collected in a table, list or observation record. A graph then converts that information into a visual pattern so that comparisons, changes and relationships can be recognised quickly."},
        {type:"definition", title:"Data", text:"Data is a collection of facts, measurements or observations. It may be numerical or categorical."},
        {type:"definition", title:"Variable", text:"A variable is a quantity whose value can change. In a graph, one variable is often represented on the horizontal axis and another on the vertical axis."},
        {type:"paragraph", title:"Choosing the correct graph", text:"Use a bar graph mainly to compare separate categories. Use a line graph when values are ordered and change over time or another continuous quantity. Use a coordinate graph when the position of points or a mathematical relationship is being studied."},
        {type:"graph", title:"The same idea can be visualised in different ways", html:`
<svg viewBox="0 0 900 500" class="cqMathFigure" role="img" aria-label="Three graph types overview">
<rect width="900" height="500" rx="24" fill="#fbfcff"/>
<text x="150" y="55" text-anchor="middle" font-size="25" font-weight="800">Bar Graph</text>
<line x1="60" y1="390" x2="250" y2="390" stroke="#111827" stroke-width="4"/>
<line x1="60" y1="100" x2="60" y2="390" stroke="#111827" stroke-width="4"/>
<rect x="85" y="270" width="35" height="120" fill="#6366f1"/><rect x="145" y="190" width="35" height="200" fill="#6366f1"/><rect x="205" y="230" width="35" height="160" fill="#6366f1"/>
<text x="450" y="55" text-anchor="middle" font-size="25" font-weight="800">Line Graph</text>
<line x1="330" y1="390" x2="570" y2="390" stroke="#111827" stroke-width="4"/>
<line x1="330" y1="100" x2="330" y2="390" stroke="#111827" stroke-width="4"/>
<polyline points="340,360 390,310 440,330 490,210 540,140" fill="none" stroke="#4f46e5" stroke-width="6"/>
<circle cx="340" cy="360" r="7" fill="#ef4444"/><circle cx="390" cy="310" r="7" fill="#ef4444"/><circle cx="440" cy="330" r="7" fill="#ef4444"/><circle cx="490" cy="210" r="7" fill="#ef4444"/><circle cx="540" cy="140" r="7" fill="#ef4444"/>
<text x="750" y="55" text-anchor="middle" font-size="25" font-weight="800">Coordinate Graph</text>
<line x1="640" y1="250" x2="850" y2="250" stroke="#111827" stroke-width="4"/>
<line x1="745" y1="390" x2="745" y2="100" stroke="#111827" stroke-width="4"/>
<circle cx="805" cy="165" r="9" fill="#16a34a"/><text x="820" y="155" font-size="20" font-weight="700">(3,2)</text>
<circle cx="685" cy="330" r="9" fill="#16a34a"/><text x="650" y="355" font-size="20" font-weight="700">(−2,−2)</text>
<text x="450" y="460" text-anchor="middle" font-size="21" font-weight="700">Choose the graph according to the type of information.</text>
</svg>`},
        {type:"tip", title:"Before you draw", text:"Ask four questions: What are the quantities? Which quantity belongs on each axis? What scale is suitable? Which graph type represents the data most clearly?"},
        {type:"example", title:"Solved Example — Choosing a graph", text:"The number of students in four different houses is categorical data, so a bar graph is appropriate. The temperature recorded every hour during a day is ordered over time, so a line graph is appropriate."}
      ]
    },
    {
...
<text x="190" y="95" font-size="18" fill="#4f46e5">■ Boys</text><text x="300" y="95" font-size="18" fill="#16a34a">■ Girls</text>
    ...
    {
      title: "14A. Extra Graph Practice — Read, Draw and Reason",
      blocks: [
        {type:"paragraph", title:"Read from a graph", text:"1. Draw a coordinate plane and mark A(−3,2), B(3,2), C(3,−2) and D(−3,−2). Join the points. 2. State the quadrant of each point. 3. Which points have the same y-coordinate?"},
        {type:"paragraph", title:"Draw from a table", text:"4. Plot the points (0,0), (1,2), (2,4), (3,6), (4,8). Describe the pattern visible in the graph."},
        {type:"paragraph", title:"Bar-graph task", text:"5. The numbers of books read by five students are 3, 6, 4, 8 and 5. Draw a bar graph using a suitable scale and write two conclusions."},
        {type:"paragraph", title:"Line-graph task", text:"6. A vehicle travels 0, 20, 40, 60 and 80 km at 0, 1, 2, 3 and 4 hours. Draw the line graph and answer: distance at 3 hours, increase from 1 to 4 hours, and overall trend."},
        {type:"paragraph", title:"Reasoning", text:"7. A point changes from (2,−4) to (2,5). What stays the same? 8. A point changes from (−6,3) to (4,3). What stays the same? Explain using the axes."}
      ]
    },
    {

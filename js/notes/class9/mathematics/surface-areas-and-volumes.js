...
ChapterData.sections.push([
  {
    "id": "deep-1",
    "title": "Choosing the solid and the correct measurement",
    "blocks": [
      {
        "type": "concept",
        "title": "Deep Concept Explanation",
        "color": "blue",
        "text": "Identify the solid first: cuboid, cube, cylinder, cone or sphere. Then identify exactly what is requested: lateral/curved surface area, total surface area or volume. Surface area is measured in square units; volume is measured in cubic units. A diagram should be labelled before substitution."
      },
      {
        "type": "example",
        "title": "Worked Example Insight",
        "color": "orange",
        "text": "A cylinder has r=7 cm and h=10 cm. CSA=2πrh=140π cm², while volume=πr²h=490π cm³. The important exam habit is to write the governing formula/theorem first, then substitute."
      },
      {
        "type": "tip",
        "title": "Exam Strategy",
      ...
      {
        "type": "practice",
        "title": "Practice — Choosing the solid and the correct measurement",
        "color": "purple",
        "questions": [
          {
            "topic": "Choosing the solid and the correct measurement",
            "difficulty": "Basic",
            "question": "State the main idea of choosing the solid and the correct measurement in one sentence.",
            "answer": "Identify the solid first: cuboid, cube, cylinder, cone or sphere.",
            "solution": "Read the definition/concept carefully and identify the key condition or relationship."
          },
          {
            "topic": "Choosing the solid and the correct measurement",
            "difficulty": "Understanding",
            "question": "Explain why the key condition in choosing the solid and the correct measurement matters.",
          ...
          },
          {
            "topic": "Choosing the solid and the correct measurement",
            "difficulty": "Application",
            "question": "Use the following worked idea as a model: A cylinder has r=7 cm and h=10 cm. CSA=2πrh=140π cm², while volume=πr²h=490π cm³. What is the first calculation you should write?",
          ...
          },
          {
            "topic": "Choosing the solid and the correct measurement",
            "difficulty": "HOTS",
            "question": "A student applies a formula from choosing the solid and the correct measurement without checking its conditions. Is that valid? Explain.",
          ...
          },
          {
            "topic": "Choosing the solid and the correct measurement",
            "difficulty": "Challenge",
            "question": "Create a short problem that requires choosing the solid and the correct measurement, then describe the solution strategy.",
  ...
  {
    "id": "deep-2",
    "title": "Cuboid — derive the total surface area",
    "blocks": [
      {
        "type": "concept",
        "title": "Deep Concept Explanation",
        "color": "blue",
        "text": "A cuboid has three pairs of equal rectangular faces: lb, bh and hl. Adding all six faces gives 2lb+2bh+2hl=2(lb+bh+hl). Thus TSA=2(lb+bh+hl), while volume=lbh. Lateral surface area when standing on base l×b is 2h(l+b)."
      },
      {
        "type": "example",
        "title": "Worked Example Insight",
        "color": "orange",
        "text": "For l=8,b=5,h=3, TSA=2(40+15+24)=158 cm² and volume=120 cm³. The important exam habit is to write the governing formula/theorem first, then substitute."
      },
      {
        "type": "tip",
        "title": "Exam Strategy",
      ...
      {
        "type": "practice",
        "title": "Practice — Cuboid — derive the total surface area",
        "color": "purple",
        "questions": [
          {
            "topic": "Cuboid — derive the total surface area",
            "difficulty": "Basic",
            "question": "State the main idea of cuboid — derive the total surface area in one sentence.",
            "answer": "A cuboid has three pairs of equal rectangular faces: lb, bh and hl.",
            "solution": "Read the definition/concept carefully and identify the key condition or relationship."
          },
          {
            "topic": "Cuboid — derive the total surface area",
            "difficulty": "Understanding",
            "question": "Explain why the key condition in cuboid — derive the total surface area matters.",
            "answer": "The condition determines when the stated rule or formula is valid.",
            "solution": "First identify the condition, then connect it to the theorem/formula before substituting any values."
          },
          {
            "topic": "Cuboid — derive the total surface area",
            "difficulty": "Application",
            "question": "Use the following worked idea as a model: For l=8,b=5,h=3, TSA=2(40+15+24)=158 cm² and volume=120 cm³. What is the first calculation you should write?",
            "answer": "Write the relevant formula/theorem and identify all known quantities before calculating.",
            "solution": "Step 1: list the given quantities. Step 2: choose the matching formula/theorem. Step 3: substitute with units."
          },
          {
            "topic": "Cuboid — derive the total surface area",
            "difficulty": "HOTS",
            "question": "A student applies a formula from cuboid — derive the total surface area without checking its conditions. Is that valid? Explain.",
            "answer": "Not necessarily. A formula/theorem can only be applied when its hypotheses are satisfied.",
            "solution": "Check every required condition, reject the method if a condition fails, and select a valid alternative."
          },
          {
            "topic": "Cuboid — derive the total surface area",
            "difficulty": "Challenge",
            "question": "Create a short problem that requires cuboid — derive the total surface area, then describe the solution strategy.",
            "answer": "A valid problem must provide sufficient information and require the identified concept.",
            "solution": "Choose realistic givens, state the target quantity, select the theorem/formula, calculate step-by-step, and verify units or logical conditions."
          }
        ]
  ...
  {
    "id": "deep-3",
    "title": "Cube — special case of cuboid",
    "blocks": [
      {
        "type": "concept",
        "title": "Deep Concept Explanation",
        "color": "blue",
        "text": "A cube has l=b=h=a. Substituting into cuboid formulas gives TSA=6a² and volume=a³. Its lateral surface area is 4a² when four side faces are counted. Be careful not to use 6a² when only the four lateral faces are requested."
      },
      {
        "type": "example",
        "title": "Worked Example Insight",
        "color": "orange",
        "text": "For a=6 cm, LSA=144 cm², TSA=216 cm² and volume=216 cm³. The important exam habit is to write the governing formula/theorem first, then substitute."
      },
      {
        "type": "tip",
        "title": "Exam Strategy",
      ...
      {
        "type": "practice",
        "title": "Practice — Cube — special case of cuboid",
        "color": "purple",
        "questions": [
          {
            "topic": "Cube — special case of cuboid",
            "difficulty": "Basic",
            "question": "State the main idea of cube — special case of cuboid in one sentence.",
            "answer": "A cube has l=b=h=a.",
            "solution": "Read the definition/concept carefully and identify the key condition or relationship."
          },
          {
            "topic": "Cube — special case of cuboid",
            "difficulty": "Understanding",
            "question": "Explain why the key condition in cube — special case of cuboid matters.",
            "answer": "The condition determines when the stated rule or formula is valid.",
            "solution": "First identify the condition, then connect it to the theorem/formula before substituting any values."
          },
          {
            "topic": "Cube — special case of cuboid",
            "difficulty": "Application",
            "question": "Use the following worked idea as a model: For a=6 cm, LSA=144 cm², TSA=216 cm² and volume=216 cm³. What is the first calculation you should write?",
            "answer": "Write the relevant formula/theorem and identify all known quantities before calculating.",
            "solution": "Step 1: list the given quantities. Step 2: choose the matching formula/theorem. Step 3: substitute with units."
          },
          {
            "topic": "Cube — special case of cuboid",
            "difficulty": "HOTS",
            "question": "A student applies a formula from cube — special case of cuboid without checking its conditions. Is that valid? Explain.",
            "answer": "Not necessarily. A formula/theorem can only be applied when its hypotheses are satisfied.",
            "solution": "Check every required condition, reject the method if a condition fails, and select a valid alternative."
          },
          {
            "topic": "Cube — special case of cuboid",
            "difficulty": "Challenge",
            "question": "Create a short problem that requires cube — special case of cuboid, then describe the solution strategy.",
            "answer": "A valid problem must provide sufficient information and require the identified concept.",
            "solution": "Choose realistic givens, state the target quantity, select the theorem/formula, calculate step-by-step, and verify units or logical conditions."
          }
        ]
  ...
  {
    "id": "deep-4",
    "title": "Cylinder — curved versus total surface area",
    "blocks": [
      {
        "type": "concept",
        "title": "Deep Concept Explanation",
        "color": "blue",
        "text": "A cylinder has two circular bases and one curved surface. Unrolling the curved surface gives a rectangle of length 2πr and height h, so CSA=(2πr)h=2πrh. Adding two bases gives TSA=2πrh+2πr²=2πr(h+r). Volume is base area×height=πr²h."
      },
      {
        "type": "example",
        "title": "Worked Example Insight",
        "color": "orange",
        "text": "For r=3,h=8, CSA=48π cm², TSA=66π cm², volume=72π cm³. The important exam habit is to write the governing formula/theorem first, then substitute."
      },
      {
        "type": "tip",
        "title": "Exam Strategy",
      ...
      {
        "type": "practice",
        "title": "Practice — Cylinder — curved versus total surface area",
        "color": "purple",
        "questions": [
          {
            "topic": "Cylinder — curved versus total surface area",
            "difficulty": "Basic",
            "question": "State the main idea of cylinder — curved versus total surface area in one sentence.",
            "answer": "A cylinder has two circular bases and one curved surface.",
            "solution": "Read the definition/concept carefully and identify the key condition or relationship."
          },
          {
            "topic": "Cylinder — curved versus total surface area",
            "difficulty": "Understanding",
            "question": "Explain why the key condition in cylinder — curved versus total surface area matters.",
            "answer": "The condition determines when the stated rule or formula is valid.",
            "solution": "First identify the condition, then connect it to the theorem/formula before substituting any values."
          },
          {
            "topic": "Cylinder — curved versus total surface area",
            "difficulty": "Application",
            "question": "Use the following worked idea as a model: For r=3,h=8, CSA=48π cm², TSA=66π cm², volume=72π cm³. What is the first calculation you should write?",
            "answer": "Write the relevant formula/theorem and identify all known quantities before calculating.",
            "solution": "Step 1: list the given quantities. Step 2: choose the matching formula/theorem. Step 3: substitute with units."
          },
          {
            "topic": "Cylinder — curved versus total surface area",
            "difficulty": "HOTS",
            "question": "A student applies a formula from cylinder — curved versus total surface area without checking its conditions. Is that valid? Explain.",
            "answer": "Not necessarily. A formula/theorem can only be applied when its hypotheses are satisfied.",
            "solution": "Check every required condition, reject the method if a condition fails, and select a valid alternative."
          },
          {
            "topic": "Cylinder — curved versus total surface area",
            "difficulty": "Challenge",
            "question": "Create a short problem that requires cylinder — curved versus total surface area, then describe the solution strategy.",
            "answer": "A valid problem must provide sufficient information and require the identified concept.",
            "solution": "Choose realistic givens, state the target quantity, select the theorem/formula, calculate step-by-step, and verify units or logical conditions."
          }
        ]
  ...
  {
    "id": "deep-5",
    "title": "Cone — slant height and surface area",
    "blocks": [
      {
        "type": "concept",
        "title": "Deep Concept Explanation",
        "color": "blue",
        "text": "A cone has radius r, vertical height h and slant height l. For a right circular cone, l=√(r²+h²). The curved surface area is πrl and total surface area is πr(l+r). Volume is (1/3)πr²h. Never substitute vertical height for slant height in CSA."
      },
      {
        "type": "example",
        "title": "Worked Example Insight",
        "color": "orange",
        "text": "For r=5,h=12, l=13. CSA=65π cm², TSA=90π cm², volume=100π cm³. The important exam habit is to write the governing formula/theorem first, then substitute."
      },
      {
        "type": "tip",
        "title": "Exam Strategy",
      ...
      {
        "type": "practice",
        "title": "Practice — Cone — slant height and surface area",
        "color": "purple",
        "questions": [
          {
            "topic": "Cone — slant height and surface area",
            "difficulty": "Basic",
            "question": "State the main idea of cone — slant height and surface area in one sentence.",
            "answer": "A cone has radius r, vertical height h and slant height l.",
            "solution": "Read the definition/concept carefully and identify the key condition or relationship."
          },
          {
            "topic": "Cone — slant height and surface area",
            "difficulty": "Understanding",
            "question": "Explain why the key condition in cone — slant height and surface area matters.",
            "answer": "The condition determines when the stated rule or formula is valid.",
            "solution": "First identify the condition, then connect it to the theorem/formula before substituting any values."
          },
          {
            "topic": "Cone — slant height and surface area",
            "difficulty": "Application",
            "question": "Use the following worked idea as a model: For r=5,h=12, l=13. CSA=65π cm², TSA=90π cm², volume=100π cm³. What is the first calculation you should write?",
            "answer": "Write the relevant formula/theorem and identify all known quantities before calculating.",
            "solution": "Step 1: list the given quantities. Step 2: choose the matching formula/theorem. Step 3: substitute with units."
          },
          {
            "topic": "Cone — slant height and surface area",
            "difficulty": "HOTS",
            "question": "A student applies a formula from cone — slant height and surface area without checking its conditions. Is that valid? Explain.",
            "answer": "Not necessarily. A formula/theorem can only be applied when its hypotheses are satisfied.",
            "solution": "Check every required condition, reject the method if a condition fails, and select a valid alternative."
          },
          {
            "topic": "Cone — slant height and surface area",
            "difficulty": "Challenge",
            "question": "Create a short problem that requires cone — slant height and surface area, then describe the solution strategy.",
            "answer": "A valid problem must provide sufficient information and require the identified concept.",
            "solution": "Choose realistic givens, state the target quantity, select the theorem/formula, calculate step-by-step, and verify units or logical conditions."
          }
        ]
    ...
    "blocks": [
      {
        ...
        "title": "Deep Concept Explanation",
        "color": "blue",
        "text": "A sphere has surface area 4πr² and volume (4/3)πr³. A hemisphere is half a sphere. Its curved surface area is 2πr²; its total surface area includes the circular base and equals 3πr². Its volume is (2/3)πr³."
      },
      {
        "type": "example",
        "title": "Worked Example Insight",
        "color": "orange",
        "text": "For r=7, hemisphere CSA=98π cm² and TSA=147π cm². The important exam habit is to write the governing formula/theorem first, then substitute."
      },
      {
        "type": "tip",
        "title": "Exam Strategy",
      ...
      },
      {
        ...
        "questions": [
          {
            "topic": "Sphere and hemisphere",
            "difficulty": "Basic",
            "question": "State the main idea of sphere and hemisphere in one sentence.",
            "answer": "A sphere has surface area 4πr² and volume (4/3)πr³.",
            "solution": "Read the definition/concept carefully and identify the key condition or relationship."
          },
          {
            "topic": "Sphere and hemisphere",
            "difficulty": "Understanding",
            "question": "Explain why the key condition in sphere and hemisphere matters.",
            "answer": "The condition determines when the stated rule or formula is valid.",
            "solution": "First identify the condition, then connect it to the theorem/formula before substituting any values."
          },
          {
            "topic": "Sphere and hemisphere",
            "difficulty": "Application",
            "question": "Use the following worked idea as a model: For r=7, hemisphere CSA=98π cm² and TSA=147π cm². What is the first calculation you should write?",
            "answer": "Write the relevant formula/theorem and identify all known quantities before calculating.",
            "solution": "Step 1: list the given quantities. Step 2: choose the matching formula/theorem. Step 3: substitute with units."
          },
          {
            "topic": "Sphere and hemisphere",
            "difficulty": "HOTS",
            "question": "A student applies a formula from sphere and hemisphere without checking its conditions. Is that valid? Explain.",
            "answer": "Not necessarily. A formula/theorem can only be applied when its hypotheses are satisfied.",
            "solution": "Check every required condition, reject the method if a condition fails, and select a valid alternative."
          },
          {
            "topic": "Sphere and hemisphere",
            "difficulty": "Challenge",
            "question": "Create a short problem that requires sphere and hemisphere, then describe the solution strategy.",
            "answer": "A valid problem must provide sufficient information and require the identified concept.",
            "solution": "Choose realistic givens, state the target quantity, select the theorem/formula, calculate step-by-step, and verify units or logical conditions."
          }
        ]
  ...
  {
    "id": "deep-7",
    "title": "Unit conversion and scaling",
    "blocks": [
      {
        "type": "concept",
        "title": "Deep Concept Explanation",
        "color": "blue",
        "text": "Convert all dimensions to one unit before using formulas. If a length is multiplied by k, area is multiplied by k² and volume by k³. This scaling idea helps detect impossible numerical answers."
      },
      {
        "type": "example",
        "title": "Worked Example Insight",
        "color": "orange",
        "text": "If every dimension doubles, TSA becomes four times as large and volume becomes eight times as large. The important exam habit is to write the governing formula/theorem first, then substitute."
      },
      {
        "type": "tip",
        "title": "Exam Strategy",
      ...
      {
        "type": "practice",
        "title": "Practice — Unit conversion and scaling",
        "color": "purple",
        "questions": [
          {
            "topic": "Unit conversion and scaling",
            "difficulty": "Basic",
            "question": "State the main idea of unit conversion and scaling in one sentence.",
            "answer": "Convert all dimensions to one unit before using formulas.",
            "solution": "Read the definition/concept carefully and identify the key condition or relationship."
          },
          {
            "topic": "Unit conversion and scaling",
            "difficulty": "Understanding",
            "question": "Explain why the key condition in unit conversion and scaling matters.",
            "answer": "The condition determines when the stated rule or formula is valid.",
            "solution": "First identify the condition, then connect it to the theorem/formula before substituting any values."
          },
          {
            "topic": "Unit conversion and scaling",
            "difficulty": "Application",
            "question": "Use the following worked idea as a model: If every dimension doubles, TSA becomes four times as large and volume becomes eight times as large. What is the first calculation you should write?",
            "answer": "Write the relevant formula/theorem and identify all known quantities before calculating.",
            "solution": "Step 1: list the given quantities. Step 2: choose the matching formula/theorem. Step 3: substitute with units."
          },
          {
            "topic": "Unit conversion and scaling",
            "difficulty": "HOTS",
            "question": "A student applies a formula from unit conversion and scaling without checking its conditions. Is that valid? Explain.",
            "answer": "Not necessarily. A formula/theorem can only be applied when its hypotheses are satisfied.",
            "solution": "Check every required condition, reject the method if a condition fails, and select a valid alternative."
          },
          {
            "topic": "Unit conversion and scaling",
            "difficulty": "Challenge",
            "question": "Create a short problem that requires unit conversion and scaling, then describe the solution strategy.",
            "answer": "A valid problem must provide sufficient information and require the identified concept.",
            "solution": "Choose realistic givens, state the target quantity, select the theorem/formula, calculate step-by-step, and verify units or logical conditions."
          }
        ]
  ...
  {
    "id": "deep-8",
    "title": "Composite solids and exposed surfaces",
    "blocks": [
      {
        "type": "concept",
        "title": "Deep Concept Explanation",
        "color": "blue",
        "text": "For a combination of solids, add only the surfaces actually exposed. A circular face glued to another solid is internal and should not be counted. For volume, add or subtract component volumes according to the physical shape."
      },
      {
        "type": "example",
        "title": "Worked Example Insight",
        "color": "orange",
        "text": "A cylinder with a hemisphere attached at one circular base has exposed area equal to cylinder CSA plus hemisphere CSA plus the remaining cylinder base, if that base is exposed. The important exam habit is to write the governing formula/theorem first, then substitute."
      },
      {
        "type": "tip",
        "title": "Exam Strategy",
      ...
      {
        "type": "practice",
        "title": "Practice — Composite solids and exposed surfaces",
        "color": "purple",
        "questions": [
          {
            "topic": "Composite solids and exposed surfaces",
            "difficulty": "Basic",
            "question": "State the main idea of composite solids and exposed surfaces in one sentence.",
            "answer": "For a combination of solids, add only the surfaces actually exposed.",
            "solution": "Read the definition/concept carefully and identify the key condition or relationship."
          },
          {
            "topic": "Composite solids and exposed surfaces",
            "difficulty": "Understanding",
            "question": "Explain why the key condition in composite solids and exposed surfaces matters.",
            "answer": "The condition determines when the stated rule or formula is valid.",
            "solution": "First identify the condition, then connect it to the theorem/formula before substituting any values."
          },
          {
            "topic": "Composite solids and exposed surfaces",
            "difficulty": "Application",
            "question": "Use the following worked idea as a model: A cylinder with a hemisphere attached at one circular base has exposed area equal to cylinder CSA plus hemisphere CSA plus the remaining cylinder base, if that base is exposed. What is the first calculation you should write?",
            "answer": "Write the relevant formula/theorem and identify all known quantities before calculating.",
            "solution": "Step 1: list the given quantities. Step 2: choose the matching formula/theorem. Step 3: substitute with units."
          },
          {
            "topic": "Composite solids and exposed surfaces",
            "difficulty": "HOTS",
            "question": "A student applies a formula from composite solids and exposed surfaces without checking its conditions. Is that valid? Explain.",
            "answer": "Not necessarily. A formula/theorem can only be applied when its hypotheses are satisfied.",
            "solution": "Check every required condition, reject the method if a condition fails, and select a valid alternative."
          },
          {
            "topic": "Composite solids and exposed surfaces",
            "difficulty": "Challenge",
            "question": "Create a short problem that requires composite solids and exposed surfaces, then describe the solution strategy.",
            "answer": "A valid problem must provide sufficient information and require the identified concept.",
            "solution": "Choose realistic givens, state the target quantity, select the theorem/formula, calculate step-by-step, and verify units or logical conditions."
          }
        ]
...
ChapterData.theoremPropertyLab=[{"title": "Cone relationship", "statement": "l²=r²+h² and CSA=πrl.", "conditions": "Right circular cone."}];
ChapterData.realLifeMathematics=["Packaging", "Tanks", "Construction", "Manufacturing"];
ChapterData.mathematicalActivityLab=[{"title": "Net lab", "steps": ["Draw a net.", "Label faces.", "Add areas.", "Relate net to solid."]}];
ChapterData.visualLearning=["Draw cone with r,h,l.", "Draw cylinder net.", "Show hemisphere base."];

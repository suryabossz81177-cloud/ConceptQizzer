...
window.ChapterData = {
  ...
  "enabled": true,
  "description": "An ultra-detailed Class 9 Biology chapter covering crop variety improvement, crop production and protection, and scientific management of livestock, fisheries and apiculture.",
  "learningObjectives": [
    "Explain why food resources need scientific improvement.",
    "Describe crop variety improvement goals.",
    "Explain nutrient, manure, fertiliser and irrigation management.",
    "Differentiate mixed cropping, intercropping and crop rotation.",
    "Explain crop protection and storage management.",
    "Describe cattle, poultry, fish and bee management.",
    "Evaluate food-production choices using productivity and sustainability criteria."
  ],
  "prerequisiteCheck": [
    "Basic plant nutrition",
    "Photosynthesis and plant growth",
    "Basic understanding of domestic animals and agriculture"
  ],
  "conceptRoadmap": [
    "Need for Improvement in Food Resources",
  ...
  "sections": [
    {
      "id": "topic-1",
      "title": "Need for Improvement in Food Resources",
      "type": "concept",
      "explanation": "Food production must increase sustainably because population, nutrition needs and available resources create continuing demands. Improvement includes better crop varieties, efficient crop production practices, protection from pests and diseases, and scientific management of animal husbandry.",
      "conceptExpansion": [
        "Core reasoning for Need for Improvement in Food Resources: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          "term": "Need for Improvement in Food Resources",
          "definition": "Improvement in food resources aims to increase food quantity and quality while using land, water and other resources efficiently."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
        "Prevention is often more sustainable than correcting severe damage later.",
        "Scientific management combines observation with appropriate intervention.",
        "Sustainable practices protect future productivity."
      ],
      "figures": [],
      "workedExamples": [
        {
      ...
      "commonMistakes": [
        "Assuming more fertiliser always means more yield.",
        "Confusing manure with fertiliser.",
        "Treating all irrigation methods as equally efficient.",
        "Ignoring disease prevention in animal husbandry.",
        "Writing only advantages without conditions or limitations."
      ],
      "examPoints": [
        "Learn the purpose and method of each practice.",
        "Use comparison tables for mixed cropping/intercropping/crop rotation.",
        "For animal husbandry, remember breeding, feeding, housing and disease control.",
        "For sustainability questions, mention both productivity and conservation."
      ]
    },
    {
      "id": "topic-2",
      ...
      "type": "concept",
      "explanation": "Crop variety improvement aims to develop varieties with desirable traits such as higher yield, improved quality, resistance to biotic and abiotic stresses, shorter or suitable maturity duration and wider adaptability.",
      "conceptExpansion": [
        "Core reasoning for Crop Variety Improvement: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          "term": "Crop Variety Improvement",
          "definition": "Crop variety improvement develops or selects varieties with desirable traits such as high yield, quality and resistance to stresses."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
    ...
    },
    {
      ...
      "type": "concept",
      "explanation": "Crop production management includes nutrient management, irrigation, cropping patterns and proper use of agricultural inputs. The aim is to provide crops with suitable conditions while avoiding waste and environmental damage.",
      "conceptExpansion": [
        "Core reasoning for Crop Production Management: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          "term": "Crop Production Management",
          "definition": "Crop production management includes nutrient management, irrigation, cropping patterns and other practices used to obtain good crop yield."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
    ...
    {
      "id": "topic-4",
      "title": "Nutrients: Macronutrients and Micronutrients",
      "type": "concept",
      "explanation": "Plants require essential mineral nutrients. Macronutrients are needed in relatively large amounts, while micronutrients are needed in smaller amounts. Deficiency of a nutrient can produce characteristic growth abnormalities.",
      "conceptExpansion": [
        "Core reasoning for Nutrients: Macronutrients and Micronutrients: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          "term": "Nutrients: Macronutrients and Micronutrients",
          "definition": "Plants require macronutrients in relatively large amounts and micronutrients in much smaller amounts for healthy growth."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
    ...
    },
    {
      ...
      "title": "Manure",
      "type": "concept",
      "explanation": "Manure is an organic material prepared from decomposed plant and animal residues. It adds organic matter, improves soil structure and can supply nutrients more gradually than concentrated chemical fertilisers.",
      "conceptExpansion": [
        "Core reasoning for Manure: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          "term": "Manure",
          "definition": "Manure is decomposed plant and animal waste that adds organic matter and nutrients to soil."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
    ...
    },
    {
      ...
      "title": "Fertilisers",
      "type": "concept",
      "explanation": "Fertilisers are commercially prepared nutrient-rich materials supplied to crops. They can provide nutrients rapidly, but excessive or inappropriate use can contribute to soil, water and ecological problems.",
      "conceptExpansion": [
        "Core reasoning for Fertilisers: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          "term": "Fertilisers",
          "definition": "Fertilisers are concentrated nutrient materials supplied to crops to provide specific mineral nutrients."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
    ...
    },
    {
      ...
      "title": "Irrigation",
      "type": "concept",
      "explanation": "Irrigation is the controlled supply of water to crops. Traditional and modern methods differ in efficiency; systems such as sprinkler and drip irrigation can reduce wastage when appropriately designed.",
      "conceptExpansion": [
        "Core reasoning for Irrigation: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          "term": "Irrigation",
          "definition": "Irrigation is the artificial supply of water to crops at suitable intervals."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
    ...
    },
    {
      ...
      "type": "concept",
      "explanation": "Mixed cropping, intercropping and crop rotation are methods of arranging crops in time or space. They can improve resource use, reduce risk and help maintain soil fertility when correctly planned.",
      "conceptExpansion": [
        "Core reasoning for Cropping Patterns: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          ...
          "definition": "Cropping patterns are planned arrangements of crops, including mixed cropping, intercropping and crop rotation."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
    ...
    {
      "id": "topic-9",
      "title": "Crop Protection Management",
      "type": "concept",
      "explanation": "Crops may be damaged by weeds, insects, pathogens and storage pests. Integrated approaches combine preventive practices, resistant varieties, biological control, cultural methods and carefully targeted chemical control.",
      "conceptExpansion": [
        "Core reasoning for Crop Protection Management: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          "term": "Crop Protection Management",
          "definition": "Crop protection management prevents or reduces losses caused by weeds, pests, diseases and poor storage conditions."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
    ...
    },
    {
      ...
      "type": "concept",
      "explanation": "Animal husbandry is the scientific management of domesticated animals for useful products such as milk, eggs, meat, fibre and other materials. It includes breeding, feeding, housing and disease control.",
      "conceptExpansion": [
        "Core reasoning for Animal Husbandry: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          ...
          "definition": "Animal husbandry is the scientific management of domesticated animals for useful products."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
    ...
    },
    {
      ...
      "type": "concept",
      "explanation": "Cattle may be managed for milk production or draught purposes. Successful management depends on suitable breeds, balanced feed, clean housing, hygiene, vaccination and disease prevention.",
      "conceptExpansion": [
        "Core reasoning for Cattle Farming: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          "term": "Cattle Farming",
          "definition": "Cattle farming involves suitable breeds, feeding, shelter, breeding and disease control for cattle reared for milk or draught work."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
    ...
    },
    {
      ...
      "type": "concept",
      "explanation": "Poultry farming involves rearing birds for eggs or meat. Breeding, nutrition, housing, temperature control, sanitation and disease management influence productivity.",
      "conceptExpansion": [
        "Core reasoning for Poultry Farming: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          ...
          "definition": "Poultry farming is the scientific rearing of birds such as chickens for eggs and meat."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
    ...
    },
    {
      ...
      "type": "concept",
      "explanation": "Fish production includes capture fisheries and culture fisheries. Composite fish culture can use different feeding zones in a pond so that species compete less strongly for the same food resources.",
      "conceptExpansion": [
        "Core reasoning for Fish Production: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          ...
          "definition": "Fish production is obtaining fish through capture fisheries or controlled culture systems."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
    ...
    },
    {
      ...
      "title": "Bee-keeping",
      "type": "concept",
      "explanation": "Apiculture is the rearing and management of honeybees. Honey and beeswax are important products, while pollination by bees can also benefit crop production.",
      "conceptExpansion": [
        "Core reasoning for Bee-keeping: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          "term": "Bee-keeping",
          "definition": "Bee-keeping is the scientific management of honeybee colonies for honey, beeswax and pollination benefits."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
    ...
    },
    {
      ...
      "type": "concept",
      "explanation": "Aquaculture is the farming of aquatic organisms under managed conditions. It requires water-quality management, appropriate stocking, feeding and disease control.",
      "conceptExpansion": [
        "Core reasoning for Fisheries and Aquaculture: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          "term": "Fisheries and Aquaculture",
          "definition": "Fisheries involve harvesting aquatic organisms, while aquaculture involves their controlled breeding and rearing."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
    ...
    },
    {
      ...
      "type": "concept",
      "explanation": "Sustainable improvement balances yield with soil health, water conservation, biodiversity, animal welfare and long-term productivity. A high yield obtained by damaging the resource base is not a complete solution.",
      "conceptExpansion": [
        "Core reasoning for Sustainable Food Production: identify the resource, the biological need, the management practice and the expected outcome.",
        "Agriculture questions often test comparison and decision-making. State the condition first, then select the practice that best addresses it.",
        "A good answer separates biological improvement from careless overuse of inputs.",
        "For application questions, consider yield, quality, cost, resource conservation and long-term sustainability together."
      ],
      "definitions": [
        {
          ...
          "definition": "Sustainable food production meets present food needs while conserving soil, water, biodiversity and future productivity."
        }
      ],
      "keyPoints": [
        "Productivity depends on biological, environmental and management factors.",
  ...
  "comparisonTables": [
    {
      "title": "Cropping pattern comparison",
      "columns": [
        "Method",
        "Arrangement",
        "Main idea"
      ...
      "rows": [
        ...
        [
          "Intercropping",
          "Different crops in planned row patterns",
          "Better resource use"
        ],
        [
          "Crop rotation",
          "Different crops grown successively",
          "Resource/fertility management"
        ]
      ]
    },
    {
      "title": "Manure vs fertiliser",
      "columns": [
        "Feature",
        "Manure",
        "Fertiliser"
      ...
      "rows": [
        [
          "Nature",
          "Organic",
          "Usually manufactured/mineral nutrient source"
        ],
        [
        ...
        [
          "Organic matter",
          "Adds organic matter",
          "Usually does not add comparable bulk organic matter"
        ],
        [
          "Release",
          "Often slower",
        ...
        [
          "Main caution",
          "Quality and nutrient variability",
          "Excessive use can harm soil/water systems"
        ]
      ]
    },
    {
      "title": "Animal husbandry areas",
      "columns": [
        "Area",
        "Main focus",
        "Examples"
      ...
      "rows": [
        [
          "Cattle",
          "Milk/draught",
          "Breed, feed, housing, health"
        ],
        [
          "Poultry",
          "Egg/meat",
          "Breeding, feed, hygiene"
        ],
        [
          "Fisheries",
          "Fish production",
          "Stocking, feeding, water quality"
        ],
        [
          "Apiculture",
          "Honey/beeswax and pollination",
          "Colony management, disease/pest control"
        ]
      ]
    }
  ],
  "experiments": [
    {
      "title": "Comparing soil organic matter conceptually",
      "aim": "Understand how organic amendments influence soil properties.",
      "materials": [
        "Two soil samples",
      ...
      "procedure": [
        "Observe texture and water-holding differences conceptually.",
        "Discuss how decomposition adds organic material.",
        "Relate changes to soil structure and plant growth."
      ],
      "observation": "Organic matter can improve soil structure and water-holding capacity.",
      "conclusion": "Soil management is not only about adding mineral nutrients; physical and biological properties also matter.",
      "precautions": [
        "Do not claim that every manure type has identical nutrient composition."
      ]
    },
    {
      "title": "Planning an efficient cropping system",
      "aim": "Use reasoning to select a suitable cropping pattern.",
      "materials": [
        "Crop cards",
        "Simple field grid"
      ],
      "procedure": [
        "List nutrient and space needs of each crop.",
        "Place crops in a mixed or intercropped arrangement.",
        "Compare resource use and risk.",
        "Propose a rotation for the next season."
      ],
      "observation": "Different crop combinations can reduce direct competition and spread risk.",
      "conclusion": "Cropping patterns can be designed scientifically rather than chosen randomly.",
      "precautions": [
        "Consider local climate, soil, water and crop compatibility."
      ]
    }
  ],
  "revision": {
    "quickRevision": [
      "Improvement in food resources aims at higher and better-quality production with sustainable management.",
      "Crop variety improvement targets yield, quality, resistance and adaptability.",
      "Plants need macronutrients and micronutrients.",
      "Manure adds organic matter; fertilisers supply concentrated nutrients.",
      "Irrigation supplies water at suitable times.",
      "Mixed cropping, intercropping and crop rotation are distinct strategies.",
      "Crop protection includes weeds, pests, pathogens and storage losses.",
      "Animal husbandry includes breeding, feeding, housing and disease control.",
      "Fisheries include capture and culture; aquaculture is managed farming of aquatic organisms.",
      "Apiculture is scientific bee-keeping."
    ],
    "importantQuestions": [
      "Explain crop variety improvement goals.",
      "Differentiate manure and fertiliser.",
      "Compare mixed cropping, intercropping and crop rotation.",
      "Explain integrated crop protection.",
      "Describe cattle and poultry management.",
      "Explain composite fish culture.",
      "Explain the importance of bee-keeping."
    ]
  },
  "glossary": [
    {
      "front": "Need for Improvement in Food Resources",
      "back": "Improvement in food resources aims to increase food quantity and quality while using land, water and other resources efficiently."
    },
    {
      "front": "Crop Variety Improvement",
      "back": "Crop variety improvement develops or selects varieties with desirable traits such as high yield, quality and resistance to stresses."
    },
    {
      "front": "Crop Production Management",
      "back": "Crop production management includes nutrient management, irrigation, cropping patterns and other practices used to obtain good crop yield."
    },
    {
      "front": "Nutrients: Macronutrients and Micronutrients",
      "back": "Plants require macronutrients in relatively large amounts and micronutrients in much smaller amounts for healthy growth."
    },
    {
      "front": "Manure",
      "back": "Manure is decomposed plant and animal waste that adds organic matter and nutrients to soil."
    },
    {
      "front": "Fertilisers",
      "back": "Fertilisers are concentrated nutrient materials supplied to crops to provide specific mineral nutrients."
    },
    {
      "front": "Irrigation",
      "back": "Irrigation is the artificial supply of water to crops at suitable intervals."
    },
    {
      "front": "Cropping Patterns",
      "back": "Cropping patterns are planned arrangements of crops, including mixed cropping, intercropping and crop rotation."
    },
    {
      "front": "Crop Protection Management",
      "back": "Crop protection management prevents or reduces losses caused by weeds, pests, diseases and poor storage conditions."
    },
    {
      "front": "Animal Husbandry",
      "back": "Animal husbandry is the scientific management of domesticated animals for useful products."
    },
    {
      "front": "Cattle Farming",
      "back": "Cattle farming involves suitable breeds, feeding, shelter, breeding and disease control for cattle reared for milk or draught work."
    },
    {
      "front": "Poultry Farming",
      "back": "Poultry farming is the scientific rearing of birds such as chickens for eggs and meat."
    },
    {
      "front": "Fish Production",
      "back": "Fish production is obtaining fish through capture fisheries or controlled culture systems."
    },
    {
      "front": "Bee-keeping",
      "back": "Bee-keeping is the scientific management of honeybee colonies for honey, beeswax and pollination benefits."
    },
    {
      "front": "Fisheries and Aquaculture",
      "back": "Fisheries involve harvesting aquatic organisms, while aquaculture involves their controlled breeding and rearing."
    },
    {
      "front": "Sustainable Food Production",
      "back": "Sustainable food production meets present food needs while conserving soil, water, biodiversity and future productivity."
    }
  ],
  "flashcards": [
    {
  ...
  "mistakeBank": [
    "Do not treat all nutrients as required in the same quantity.",
    "Do not confuse crop rotation with intercropping.",
    "Do not assume chemical control is the only pest-management strategy.",
    "Do not ignore animal hygiene and disease prevention.",
    "Do not equate high input use with sustainable improvement."
  ],
  "figurePlacementRule": "Agricultural figures are placed beside the exact topic they illustrate, never collected at the chapter beginning.",
  "sourcesAndLicences": [
    {
      "note": "Agricultural photographs should be sourced from Wikimedia Commons or another clearly licensed repository; verify the individual file licence before redistribution."
    }
  ],
  "extendedExamBank": [
    {
      "id": "extended-1",
      "prompt": "Explain Need for Improvement in Food Resources in detail, including its definition, key features, mechanism or organisation, function/purpose and one accurate example.",
      "answerFramework": "Definition → Need for Improvement in Food Resources key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "accuracy"
    },
    {
      "id": "extended-2",
      "prompt": "Compare Crop Variety Improvement with a closely related concept from this chapter. Give at least three meaningful points of difference or connection.",
      "answerFramework": "Definition → Crop Variety Improvement key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "correct terminology"
    },
    {
      "id": "extended-3",
      "prompt": "A student encounters an unfamiliar situation involving Crop Production Management. Apply the concept step by step and justify the conclusion using correct biological terminology.",
      "answerFramework": "Definition → Crop Production Management key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "logical sequence"
    },
    {
      "id": "extended-4",
      "prompt": "Describe the structure or process involved in Nutrients: Macronutrients and Micronutrients and explain how that structure or process produces its biological effect.",
      "answerFramework": "Definition → Nutrients: Macronutrients and Micronutrients key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "application"
    },
    {
      "id": "extended-5",
      "prompt": "What would happen if a key feature of Manure were absent, reduced or changed? Explain the expected consequence and the reason.",
      "answerFramework": "Definition → Manure key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "clear conclusion"
    },
    {
      "id": "extended-6",
      "prompt": "Write an exam-ready long answer on Fertilisers. Include definition, explanation, example/application and a concluding statement.",
      "answerFramework": "Definition → Fertilisers key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "accuracy"
    },
    {
      "id": "extended-7",
      "prompt": "Explain Irrigation in detail, including its definition, key features, mechanism or organisation, function/purpose and one accurate example.",
      "answerFramework": "Definition → Irrigation key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "correct terminology"
    },
    {
      "id": "extended-8",
      "prompt": "Compare Cropping Patterns with a closely related concept from this chapter. Give at least three meaningful points of difference or connection.",
      "answerFramework": "Definition → Cropping Patterns key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "logical sequence"
    },
    {
      "id": "extended-9",
      "prompt": "A student encounters an unfamiliar situation involving Crop Protection Management. Apply the concept step by step and justify the conclusion using correct biological terminology.",
      "answerFramework": "Definition → Crop Protection Management key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "application"
    },
    {
      "id": "extended-10",
      "prompt": "Describe the structure or process involved in Animal Husbandry and explain how that structure or process produces its biological effect.",
      "answerFramework": "Definition → Animal Husbandry key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "clear conclusion"
    },
    {
      "id": "extended-11",
      "prompt": "What would happen if a key feature of Cattle Farming were absent, reduced or changed? Explain the expected consequence and the reason.",
      "answerFramework": "Definition → Cattle Farming key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "accuracy"
    },
    {
      "id": "extended-12",
      "prompt": "Write an exam-ready long answer on Poultry Farming. Include definition, explanation, example/application and a concluding statement.",
      "answerFramework": "Definition → Poultry Farming key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "correct terminology"
    },
    {
      "id": "extended-13",
      "prompt": "Explain Fish Production in detail, including its definition, key features, mechanism or organisation, function/purpose and one accurate example.",
      "answerFramework": "Definition → Fish Production key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "logical sequence"
    },
    {
      "id": "extended-14",
      "prompt": "Compare Bee-keeping with a closely related concept from this chapter. Give at least three meaningful points of difference or connection.",
      "answerFramework": "Definition → Bee-keeping key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "application"
    },
    {
      "id": "extended-15",
      "prompt": "A student encounters an unfamiliar situation involving Fisheries and Aquaculture. Apply the concept step by step and justify the conclusion using correct biological terminology.",
      "answerFramework": "Definition → Fisheries and Aquaculture key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "clear conclusion"
    },
    {
      "id": "extended-16",
      "prompt": "Describe the structure or process involved in Sustainable Food Production and explain how that structure or process produces its biological effect.",
      "answerFramework": "Definition → Sustainable Food Production key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "accuracy"
    },
    {
      "id": "extended-17",
      "prompt": "What would happen if a key feature of Need for Improvement in Food Resources were absent, reduced or changed? Explain the expected consequence and the reason.",
      "answerFramework": "Definition → Need for Improvement in Food Resources key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "correct terminology"
    },
    {
      "id": "extended-18",
      "prompt": "Write an exam-ready long answer on Crop Variety Improvement. Include definition, explanation, example/application and a concluding statement.",
      "answerFramework": "Definition → Crop Variety Improvement key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "logical sequence"
    },
    {
      "id": "extended-19",
      "prompt": "Explain Crop Production Management in detail, including its definition, key features, mechanism or organisation, function/purpose and one accurate example.",
      "answerFramework": "Definition → Crop Production Management key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "application"
    },
    {
      "id": "extended-20",
      "prompt": "Compare Nutrients: Macronutrients and Micronutrients with a closely related concept from this chapter. Give at least three meaningful points of difference or connection.",
      "answerFramework": "Definition → Nutrients: Macronutrients and Micronutrients key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "clear conclusion"
    },
    {
      "id": "extended-21",
      "prompt": "A student encounters an unfamiliar situation involving Manure. Apply the concept step by step and justify the conclusion using correct biological terminology.",
      "answerFramework": "Definition → Manure key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "accuracy"
    },
    {
      "id": "extended-22",
      "prompt": "Describe the structure or process involved in Fertilisers and explain how that structure or process produces its biological effect.",
      "answerFramework": "Definition → Fertilisers key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "correct terminology"
    },
    {
      "id": "extended-23",
      "prompt": "What would happen if a key feature of Irrigation were absent, reduced or changed? Explain the expected consequence and the reason.",
      "answerFramework": "Definition → Irrigation key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "logical sequence"
    },
    {
      "id": "extended-24",
      "prompt": "Write an exam-ready long answer on Cropping Patterns. Include definition, explanation, example/application and a concluding statement.",
      "answerFramework": "Definition → Cropping Patterns key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "application"
    },
    {
      "id": "extended-25",
      "prompt": "Explain Crop Protection Management in detail, including its definition, key features, mechanism or organisation, function/purpose and one accurate example.",
      "answerFramework": "Definition → Crop Protection Management key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "clear conclusion"
    },
    {
      "id": "extended-26",
      "prompt": "Compare Animal Husbandry with a closely related concept from this chapter. Give at least three meaningful points of difference or connection.",
      "answerFramework": "Definition → Animal Husbandry key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "accuracy"
    },
    {
      "id": "extended-27",
      "prompt": "A student encounters an unfamiliar situation involving Cattle Farming. Apply the concept step by step and justify the conclusion using correct biological terminology.",
      "answerFramework": "Definition → Cattle Farming key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "correct terminology"
    },
    {
      "id": "extended-28",
      "prompt": "Describe the structure or process involved in Poultry Farming and explain how that structure or process produces its biological effect.",
      "answerFramework": "Definition → Poultry Farming key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "logical sequence"
    },
    {
      "id": "extended-29",
      "prompt": "What would happen if a key feature of Fish Production were absent, reduced or changed? Explain the expected consequence and the reason.",
      "answerFramework": "Definition → Fish Production key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "application"
    },
    {
      "id": "extended-30",
      "prompt": "Write an exam-ready long answer on Bee-keeping. Include definition, explanation, example/application and a concluding statement.",
      "answerFramework": "Definition → Bee-keeping key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "clear conclusion"
    },
    {
      "id": "extended-31",
      "prompt": "Explain Fisheries and Aquaculture in detail, including its definition, key features, mechanism or organisation, function/purpose and one accurate example.",
      "answerFramework": "Definition → Fisheries and Aquaculture key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "accuracy"
    },
    {
      "id": "extended-32",
      "prompt": "Compare Sustainable Food Production with a closely related concept from this chapter. Give at least three meaningful points of difference or connection.",
      "answerFramework": "Definition → Sustainable Food Production key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "correct terminology"
    },
    {
      "id": "extended-33",
      "prompt": "A student encounters an unfamiliar situation involving Need for Improvement in Food Resources. Apply the concept step by step and justify the conclusion using correct biological terminology.",
      "answerFramework": "Definition → Need for Improvement in Food Resources key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "logical sequence"
    },
    {
      "id": "extended-34",
      "prompt": "Describe the structure or process involved in Crop Variety Improvement and explain how that structure or process produces its biological effect.",
      "answerFramework": "Definition → Crop Variety Improvement key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "application"
    },
    {
      "id": "extended-35",
      "prompt": "What would happen if a key feature of Crop Production Management were absent, reduced or changed? Explain the expected consequence and the reason.",
      "answerFramework": "Definition → Crop Production Management key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "clear conclusion"
    },
    {
      "id": "extended-36",
      "prompt": "Write an exam-ready long answer on Nutrients: Macronutrients and Micronutrients. Include definition, explanation, example/application and a concluding statement.",
      "answerFramework": "Definition → Nutrients: Macronutrients and Micronutrients key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "accuracy"
    },
    {
      "id": "extended-37",
      "prompt": "Explain Manure in detail, including its definition, key features, mechanism or organisation, function/purpose and one accurate example.",
      "answerFramework": "Definition → Manure key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "correct terminology"
    },
    {
      "id": "extended-38",
      "prompt": "Compare Fertilisers with a closely related concept from this chapter. Give at least three meaningful points of difference or connection.",
      "answerFramework": "Definition → Fertilisers key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "logical sequence"
    },
    {
      "id": "extended-39",
      "prompt": "A student encounters an unfamiliar situation involving Irrigation. Apply the concept step by step and justify the conclusion using correct biological terminology.",
      "answerFramework": "Definition → Irrigation key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "application"
    },
    {
      "id": "extended-40",
      "prompt": "Describe the structure or process involved in Cropping Patterns and explain how that structure or process produces its biological effect.",
      "answerFramework": "Definition → Cropping Patterns key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "clear conclusion"
    },
    {
      "id": "extended-41",
      "prompt": "What would happen if a key feature of Crop Protection Management were absent, reduced or changed? Explain the expected consequence and the reason.",
      "answerFramework": "Definition → Crop Protection Management key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "accuracy"
    },
    {
      "id": "extended-42",
      "prompt": "Write an exam-ready long answer on Animal Husbandry. Include definition, explanation, example/application and a concluding statement.",
      "answerFramework": "Definition → Animal Husbandry key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "correct terminology"
    },
    {
      "id": "extended-43",
      "prompt": "Explain Cattle Farming in detail, including its definition, key features, mechanism or organisation, function/purpose and one accurate example.",
      "answerFramework": "Definition → Cattle Farming key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "logical sequence"
    },
    {
      "id": "extended-44",
      "prompt": "Compare Poultry Farming with a closely related concept from this chapter. Give at least three meaningful points of difference or connection.",
      "answerFramework": "Definition → Poultry Farming key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "application"
    },
    {
      "id": "extended-45",
      "prompt": "A student encounters an unfamiliar situation involving Fish Production. Apply the concept step by step and justify the conclusion using correct biological terminology.",
      "answerFramework": "Definition → Fish Production key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "clear conclusion"
    },
    {
      "id": "extended-46",
      "prompt": "Describe the structure or process involved in Bee-keeping and explain how that structure or process produces its biological effect.",
      "answerFramework": "Definition → Bee-keeping key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "accuracy"
    },
    {
      "id": "extended-47",
      "prompt": "What would happen if a key feature of Fisheries and Aquaculture were absent, reduced or changed? Explain the expected consequence and the reason.",
      "answerFramework": "Definition → Fisheries and Aquaculture key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "correct terminology"
    },
    {
      "id": "extended-48",
      "prompt": "Write an exam-ready long answer on Sustainable Food Production. Include definition, explanation, example/application and a concluding statement.",
      "answerFramework": "Definition → Sustainable Food Production key feature → mechanism/structure → function or purpose → example/application → conclusion.",
      "markingFocus": "logical sequence"
    },
    {

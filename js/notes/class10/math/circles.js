...
const ChapterData = {
  ...
  "description": "Detailed Class 10 Mathematics notes for Circles. This file is grade-locked to Class 10 and contains only Class 10 content.",
  "learningObjectives": [
    "Tangent to a circle",
  ...
  "importantPoints": [
    "Use the Class 10 treatment of Circles; keep this chapter isolated from same-name chapters in other grades.",
  ...
  "sections": [
    {
      ...
      "text": "This is the Class 10 Mathematics treatment of Circles. The chapter is kept completely separate from Class 10 data. It is organised for concept clarity, step-by-step solving, board-style reasoning, verification and revision."
    },
    {
      "type": "information",

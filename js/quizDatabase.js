...
/*==================================================
  ...
  Complete multi-level quiz bank
==================================================*/
quizDatabase.class6 = quizDatabase.class6 || {};
quizDatabase.class6.science = quizDatabase.class6.science || {};
quizDatabase.class6.science["science-the-wonderful-world-of-science"] = {
  easy: [
    {question:"Science helps us understand the world mainly through…",options:["evidence and investigation","guessing","memorising without testing","rumours"],answer:0},
    {question:"What is an observation?",options:["A wild guess","Information we notice or measure","A final answer","A promise"],answer:1},
    {question:"A good scientific question should be…",options:["impossible to test","clear and testable","based only on opinion","already answered"],answer:1},
    {question:"A hypothesis is…",options:["a guaranteed fact","a testable possible explanation","a measuring instrument","a final score"],answer:1},
    {question:"In a fair test, we usually change…",options:["everything at once","one main factor","nothing","the result"],answer:1},
    {question:"Which is evidence?",options:["A measurement","A rumour","A wish","A guess"],answer:0},
    {question:"If a prediction is wrong, a scientist should…",options:["hide the result","reconsider and test again","change the data","stop asking questions"],answer:1},
    {question:"Why record observations?",options:["To compare evidence","To make the experiment longer","To avoid testing","To decorate the notebook"],answer:0},
    {question:"Which is a testable question?",options:["Is science fun?","How does light affect plant growth?","Are plants nice?","Which colour is best?"],answer:1},
    {question:"A conclusion should be based on…",options:["what we hoped","evidence from the investigation","a friend's answer","a random choice"],answer:1}
  ],
  medium: [
    {question:"A pen stops writing. Which is the best first scientific response?",options:["Throw it away","Look for possible causes and test them","Say the ink is definitely empty","Ask someone to guess"],answer:1},
    {question:"A student changes light and water together while testing a plant. What is the main problem?",options:["The plant cannot grow","It is harder to identify which factor caused the result","There is no observation","The test is too short"],answer:1},
    {question:"Which statement is a hypothesis?",options:["The plant has yellow leaves","The plant may grow better with suitable light","The ruler is 20 cm","The experiment ended"],answer:1},
    {question:"Which measurement is most useful for comparing melting ice?",options:["The student's favourite colour","Time taken to melt","A guess","The name of the ice"],answer:1},
    {question:"Why repeat an experiment?",options:["To make evidence more reliable","To guarantee the expected result","To avoid measuring","To change all variables"],answer:0},
    {question:"If two trials give different results, the best response is to…",options:["delete one result","investigate possible reasons and repeat if needed","choose the nicer result","stop recording"],answer:1},
    {question:"Which is the dependent outcome in a plant-light test?",options:["Amount of light","Plant health measured after the test","Type of pot kept constant","Amount of soil kept constant"],answer:1},
    {question:"Which is a controlled condition in a plant-light test?",options:["The light level being tested","The same type of plant used in each group","The measured growth","The final conclusion"],answer:1},
    {question:"What should you do before running a test?",options:["Decide the answer secretly","Make a prediction and plan what to observe","Change every condition","Skip the question"],answer:1},
    {question:"A surprising result is best treated as…",options:["an error to hide","evidence that may need further investigation","proof that science failed","a reason to change the data"],answer:1}
  ],
  hard: [
    {question:"A student wants to know whether surface type changes a cart's travel distance. Which plan is fairest?",options:["Change surface and slope together","Keep slope and mass the same and change surface","Change mass every trial","Choose a distance first and record it"],answer:1},
    {question:"Which question is more scientifically useful?",options:["Why are plants beautiful?","Does changing daily light from 4 h to 8 h change a plant's health index?","Are plants good?","Do plants like me?"],answer:1},
    {question:"A hypothesis predicts longer helicopter blades increase fall time. The result shows no change. What is the best conclusion?",options:["The data must be wrong","The prediction was not supported under the tested conditions","The result should be changed","Longer blades always increase fall time"],answer:1},
    {question:"Why is changing one main variable useful?",options:["It makes the experiment look simpler","It helps connect a change in the outcome to the factor being tested","It prevents all observations","It guarantees success"],answer:1},
    {question:"Which is the strongest evidence for a claim?",options:["One unsupported opinion","Repeated measurements that show a consistent pattern","A prediction alone","A friend's belief"],answer:1},
    {question:"If temperature is the variable being tested in an ice experiment, which should ideally stay constant?",options:["Temperature","Ice cube size","The result","The conclusion"],answer:1},
    {question:"What does a fair test NOT guarantee?",options:["A controlled comparison","Useful evidence","A correct hypothesis","A clear variable"],answer:2},
    {question:"A scientist changes the experiment after seeing the first result and does not record the change. Why is this a problem?",options:["It makes the test impossible to understand or repeat","It makes the result too colourful","It proves the hypothesis","It increases the temperature"],answer:0},
    {question:"Which sequence best represents scientific inquiry?",options:["Guess → hide → conclude","Observe → ask → predict → test → record → explain","Conclude → test → ask → observe","Memorise → guess → publish"],answer:1},
    {question:"Why can a wrong hypothesis still be useful?",options:["It can be tested and can lead to a better explanation","Wrong ideas are always true later","It removes the need for evidence","It guarantees a high score"],answer:0},
    {question:"A result changes when only the surface is changed. What does this support?",options:["Surface may affect the outcome under those conditions","Surface can never matter","All variables caused the result","The hypothesis is definitely true everywhere"],answer:0},
    {question:"What is the best way to compare three trials?",options:["Remember them mentally","Record the same type of measurement for each","Use different units each time","Record only the best trial"],answer:1},
    {question:"Which statement separates observation from explanation?",options:["The ice became smaller is an observation; it melted because of heat is an explanation","Both are guesses","Both are measurements","The explanation is always observed directly"],answer:0},
    {question:"A student predicts that a higher ramp slope will increase travel distance, but the roughest surface gives a shorter distance. What should the student do?",options:["Ignore the surface","Compare trials and investigate the effect of surface and slope separately","Delete the short result","Declare the prediction always true"],answer:1},
    {question:"What makes a question testable?",options:["It can be investigated by changing or comparing conditions and recording evidence","It has a difficult word","It has no possible measurement","It depends only on opinion"],answer:0}
  ],
  tooHard: [
    {question:"A plant experiment has two groups. Group A gets 6 h light and 50 mL water; Group B gets 10 h light and 80 mL water. Why is a causal conclusion difficult?",options:["Plants cannot be measured","Two main factors changed together","The groups have names","Water is measurable"],answer:1},
    {question:"Which design best tests whether blade length affects helicopter fall time?",options:["Change blade length while keeping mass and release height constant","Change blade length, mass and height together","Use a different paper type every time","Choose the fall time before releasing"],answer:0},
    {question:"A hypothesis is supported by three trials but contradicted by one. The most responsible response is to…",options:["hide the fourth trial","inspect the procedure and repeat if necessary","declare absolute proof","average without checking"],answer:1},
    {question:"Why should a measurement unit remain consistent across trials?",options:["It makes comparisons meaningful","It makes the result larger","It changes the variable","It avoids observation"],answer:0},
    {question:"A student measures plant height before and after seven days. What is the most direct dependent measurement?",options:["Change in plant height","Type of ruler","Amount of light chosen","Student's prediction"],answer:0},
    {question:"Which statement is strongest?",options:["The experiment proves this will happen for every plant","Under these tested conditions, the evidence supports the tested explanation","My prediction was correct so the hypothesis is fact","One result is enough for all situations"],answer:1},
    {question:"If a fair test produces an unexpected result, what should be checked first?",options:["The data, setup, measurements and possible sources of variation","The conclusion only","The title of the chapter","The student's favourite answer"],answer:0},
    {question:"Which pair is correctly matched?",options:["Independent variable — factor deliberately changed","Dependent variable — factor kept constant","Evidence — prediction before testing","Hypothesis — guaranteed result"],answer:0},
    {question:"A cart travels 40 cm on smooth surface and 22 cm on carpet at the same slope and mass. What is the most reasonable statement?",options:["Surface may affect travel distance","Carpet always stops every cart","Smooth surfaces have no friction","Mass was the only cause"],answer:0},
    {question:"A conclusion should mention the conditions of an experiment because…",options:["results are interpreted in the context of what was actually tested","conditions are decorative","all results apply everywhere","conditions are never important"],answer:0},
    {question:"Which action most improves reproducibility?",options:["Describe the procedure and record settings and measurements","Keep the method secret","Record only the final score","Change the procedure without noting it"],answer:0},
    {question:"A student gets 8 min, 9 min and 20 min for three identical ice trials. What is a sensible next step?",options:["Investigate the unusual trial and repeat the test","Delete 20 min automatically","Use 20 min because it is largest","Declare the average useless"],answer:0},
    {question:"What is the purpose of a prediction before testing?",options:["It gives a claim that can be compared with evidence","It guarantees the result","It replaces measurement","It prevents new questions"],answer:0},
    {question:"Which observation is most precise?",options:["The ice melted fast","The ice cube took 12 min 30 s to melt","The ice looked nice","The ice seemed warm"],answer:1},
    {question:"If changing only one factor changes the measured result repeatedly, what does that provide?",options:["Evidence of a possible relationship under the tested conditions","Proof of every possible cause","A reason to stop testing","A replacement for measurement"],answer:0},
    {question:"Why should a scientist distinguish a hypothesis from a conclusion?",options:["A hypothesis comes before testing; a conclusion interprets evidence after testing","They are always identical","A conclusion is always a guess","A hypothesis is a measurement"],answer:0},
    {question:"A student changes the light from 4 h to 8 h and gets a higher health index. What additional test is useful?",options:["Repeat with the same controlled conditions and perhaps test another light level","Change water and soil too","Stop after one trial","Remove all measurements"],answer:0},
    {question:"Which is an example of evidence rather than inference?",options:["The thermometer reads 32°C","The object must be hot because I think so","The plant is happier","The cart likes smooth floors"],answer:0},
    {question:"A variable that is kept constant is called a…",options:["controlled condition","conclusion","hypothesis","result"],answer:0},
    {question:"What is the strongest reason to repeat trials?",options:["To see whether a pattern is consistent and reduce the effect of random variation","To make the desired answer appear","To avoid planning","To increase the number of hypotheses"],answer:0}
  ],
  extreme: [
    {question:"Two explanations both fit one observation. What is the best scientific next step?",options:["Design a test that could distinguish between them","Choose the explanation you like","Declare both proven","Stop observing"],answer:0},
    {question:"A plant experiment finds that 8 h light gives the highest health index, but only one trial was performed. Which statement is most cautious?",options:["8 h is definitely optimal for all plants","8 h produced the highest result in this trial; more testing is needed","Light has no effect","The measurement is useless"],answer:1},
    {question:"Why can controlling variables improve causal reasoning?",options:["It reduces alternative explanations for a difference in the outcome","It guarantees a desired result","It removes the need for evidence","It makes all variables identical"],answer:0},
    {question:"A student changes blade length and mass together and sees longer blades give a longer fall time. What cannot be confidently concluded?",options:["That the combined change affected the result","That blade length alone caused the change","That a difference was observed","That another test is useful"],answer:1},
    {question:"Which result is most convincing for a repeated comparison?",options:["A consistent pattern across several controlled trials","One dramatic result with no record","A prediction repeated many times","A conclusion without measurements"],answer:0},
    {question:"If an experiment is poorly controlled, what kind of claim should be avoided?",options:["Strong claims about one variable causing the result","Descriptions of what was observed","Statements about the tested setup","Requests for a better test"],answer:0},
    {question:"A fair test can still have measurement error. The best response is to…",options:["Record the error or uncertainty and repeat carefully","Pretend measurements are exact","Change the data","Avoid units"],answer:0},
    {question:"A scientist observes an unexpected result. Which sequence is best?",options:["Check method → inspect evidence → form possible explanations → test again","Hide result → choose a new answer → publish","Change data → conclude → test","Ignore result → memorise"],answer:0},
    {question:"Why is 'Does temperature affect ice melting?' less specific than a useful experimental question?",options:["It does not specify enough about the temperatures, measurement or conditions","It is impossible to understand","Temperature cannot be measured","Ice cannot melt"],answer:0},
    {question:"Which would be the best dependent variable for the ice experiment?",options:["Time taken for the cube to melt","Chosen temperature","Chosen surface","Prediction"],answer:0},
    {question:"If two variables are deliberately changed in a controlled experiment, what design is needed to identify their separate effects?",options:["A planned comparison with conditions that allow each factor to be isolated","No measurements","A single trial with both changes","A conclusion before testing"],answer:0},
    {question:"What does 'under the tested conditions' protect a conclusion from?",options:["Overgeneralising beyond the evidence","Recording observations","Using a unit","Repeating trials"],answer:0},
    {question:"A student's prediction says 'higher value increases the result'. Which evidence best tests it?",options:["Measurements taken at several values while other important conditions are controlled","One measurement at the highest value","A drawing","A personal opinion"],answer:0},
    {question:"If the result does not support a hypothesis, the hypothesis should be…",options:["revised or rejected based on the evidence and tested again if useful","treated as a fact","hidden","used as the data"],answer:0},
    {question:"Which is an example of a controlled comparison?",options:["Same cart, same mass and same slope; only surface changes","Different cart, mass and slope each trial","Different measuring units each trial","Choosing only the fastest run"],answer:0},
    {question:"Why is a numerical result often useful in an investigation?",options:["It allows clearer comparisons between trials and conditions","Numbers are always correct","It removes the need for observation","It guarantees causation"],answer:0},
    {question:"A trial record contains settings, measurements and observations. What can another student do with it?",options:["Understand and potentially repeat the investigation","Know the result without testing anything","Prove every hypothesis","Avoid using evidence"],answer:0},
    {question:"Which statement best describes scientific knowledge?",options:["It can be improved when new evidence or better tests become available","It never changes","It is based only on authority","It does not require testing"],answer:0},
    {question:"A result is repeated only when the student expects it to match. Why is this poor practice?",options:["It can bias the evidence by excluding unexpected results","It makes the sample larger","It improves fairness","It controls variables"],answer:0},
    {question:"Which question most directly tests a relationship between two measurable factors?",options:["How does release height affect paper-helicopter fall time?","Why are helicopters interesting?","Is paper good?","Do students like experiments?"],answer:0},
    {question:"If the same factor is changed but the outcome varies widely between trials, what should be considered?",options:["Measurement error, uncontrolled conditions or natural variation","Only the favourite hypothesis","Deleting unusual data","Changing the answer"],answer:0},
    {question:"What is the difference between observation and inference?",options:["Observation records what is detected; inference is an explanation drawn from observations","They are identical","Inference is always a measurement","Observation is always a guess"],answer:0},
    {question:"Why should the procedure be described clearly?",options:["So the investigation can be understood, evaluated and repeated","So the result becomes larger","So predictions are unnecessary","So variables disappear"],answer:0},
    {question:"A student gets the same result after changing the variable in three independent trials. What does this strengthen?",options:["Confidence that the observed pattern is consistent in that setup","Proof that no other factor exists anywhere","A guarantee for all situations","The need to hide raw data"],answer:0},
    {question:"What is the best scientific attitude toward a failed test?",options:["Treat it as information that can improve the next question or method","Treat it as embarrassment","Change the result","Never repeat"],answer:0}
  ]
};

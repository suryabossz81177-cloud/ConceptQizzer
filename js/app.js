...
function initScienceLabHub() {
  const heroArrow = byId('vslHeroArrow');
  const selectorCard = byId('vslSelectorCard');
  if (heroArrow && selectorCard && heroArrow.dataset.bound !== 'true') {
    heroArrow.dataset.bound = 'true';
    heroArrow.addEventListener('click', function(){
      selectorCard.classList.toggle('hidden');
      heroArrow.classList.toggle('open');
      if (!selectorCard.classList.contains('hidden')) {
